...
public class ValidParentheses {
    ...
    /**
     * solve using the Deque packed by the ArrayDeque class
     * Time Complexity : O(n) for each char is checked once
     * Space Complexity: O(n) for the stack holds at max n values equal to the length of the input string
     * @param s
     * @return
     */
